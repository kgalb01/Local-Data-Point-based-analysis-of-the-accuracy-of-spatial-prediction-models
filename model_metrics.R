...
fiji_10x10_RF_model <- readRDS("path/to/fiji_10x10_RF_model_spatCV.RDS")

rlp_10x10_RF_model <- readRDS("path/to/rlp_10x10_RF_model_spatCV.RDS")

# repeat for modified data
fiji_10x10_RF_model_modified <- readRDS("path/to/fiji_10x10_RF_model_modified_spatCV.RDS")

rlp_10x10_RF_model_modified <- readRDS("path/to/rlp_10x10_RF_model_modified_spatCV.RDS")
...
writeRaster(fiji_self_10x10_aoa$AOA, "path/to/fiji_self_10x10_aoa_spatCV.grd", overwrite = TRUE)
writeRaster(rlp_fiji_10x10_aoa$AOA, "path/to/rlp_fiji_10x10_aoa_spatCV.grd", overwrite = TRUE)
...
writeRaster(rlp_self_10x10_aoa$AOA, "path/to/rlp_self_10x10_aoa_spatCV.grd", overwrite = TRUE)
...
fiji_self_10x10_aoa$AOA <- rast("results/raster/fiji/aoa/fiji_self_10x10_aoa_spatCV.grd")
fiji_self_10x10_aoa$DI <- rast("results/raster/fiji/aoa/fiji_self_10x10_di_spatCV.grd")
fiji_self_10x10_aoa$LPD <- rast("results/raster/fiji/aoa/fiji_self_10x10_lpd_spatCV.grd")
# ...
prediction_fiji_10x10 <- rast("results/raster/fiji/prediction/prediction_fiji_10x10_spatCV.tif")
# ...
...
tmap_save(combined_map, "comparison_aoa_fiji_spatCV.png", width = 20, height = 15, units = "cm")
...
tmap_save(combined_di_map, "comparison_di_fiji_spatCV.png", width = 20, height = 15, units = "cm")
...
# Save the combined map to a file
tmap_save(combined_lpd_map, "comparison_lpd_fiji_spatCV.png", width = 20, height = 15, units = "cm")
